...
# ChatGPT Prompt:
# It is completely broken again: a) Highlight stays at first word, b) WPM and 
# Timer doesn't change - stays at zero, and c) No other functionality can be 
# tested as it is fundamentally broken. Could you try to fix these?
...
class TypingTestApp:
    ...
    def get_word_start_index(self, index):
        ...
        words_text = " ".join(self.words)
        word_start = " ".join(self.words[:index])
        return len(word_start) + index
