...
# ChatGPT Prompt:
#  Now the app is broken. The timer and WPM updates are not working at all. Also, 
# highlights also not working. Could you try to fix these?
...
class TypingTestApp:
    ...
    def get_word_start_index(self, index):
        ...
        words_text = " ".join(self.words)
        return len(" ".join(self.words[:index])) + index
